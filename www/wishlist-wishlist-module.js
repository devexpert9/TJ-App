...
var WishlistPage = /** @class */ (function () {
    function WishlistPage(cd, userService, toastController, loadingController, router, events, alertController, modalController) {
        var _this = this;
        this.cd = cd;
    ...
    WishlistPage.prototype.getAllCategories = function () {
        var _this = this;
        this.userService.postData({ user_id: this.userId == 0 ? localStorage.getItem('guestUserId') : this.userId }, 'getAllCategories').subscribe(function (result) {
            _this.categories = result.data;
        }, function (err) {
            _this.categories = [];
        });
    };
    WishlistPage.prototype.getAllShops = function () {
        var _this = this;
        this.userService.postData({ user_id: this.userId == 0 ? localStorage.getItem('guestUserId') : this.userId }, 'getAllShops').subscribe(function (result) {
    ...
    WishlistPage.prototype.searchWish = function (cat, shop) {
        var _this = this;
        var dict = {
    ...
    WishlistPage.prototype.addToCart = function (wishlist, product_id, product_sale_price, product_purchase_price) {
        var _this = this;
