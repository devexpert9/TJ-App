...
var HeaderPage = /** @class */ (function () {
    ...
    HeaderPage.prototype.getWishlistProducts = function () {
        ...
        this.userService.postData(dict, 'getWishlist').subscribe(function (result) {
            _this.stopLoading();
            console.log(result);
            if (result.status == 1) {
