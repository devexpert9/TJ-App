...
.sb-material-dark .sb-wrapper {
  ...
  $color in $sb-buttons {
    &.sb-#{$button} {
      ...
      &:hover {
        box-shadow: 0 3px 1px -2px rgba($color, .2), 0 2px 2px 0 rgba($color, .14), 0 1px 5px 0 rgba($color, .12);
      }
      &:active {
        box-shadow: 0 5px 5px -3px rgba($color, .2), 0 8px 10px 1px rgba($color, .14), 0 3px 14px 2px rgba($color, .12);
      }
    }
  }
  font-family: 'Roboto',
